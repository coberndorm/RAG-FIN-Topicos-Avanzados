...
| LLM Backend | API-based: Gemini (recommended), HuggingFace, OpenAI, Groq — configurable via env vars. Groq uses `llama-3.3-70b-versatile` (the 3.1 version was decommissioned). |
